...
category: conference
permalink: /publication/2024-12-30-age-aware-remote-mdp
excerpt: 'Formulates an age-aware remote Markov decision process where sampling decisions drive remote control/decision quality, extending AoI-centric models by incorporating goal-oriented costs and side information to derive sampling policies that better support actions.'
date: 2024-12-30
venue: '2024 IEEE Information Theory Workshop (ITW)'
citation: "A. Li, S. Wu, G. C. Lee, X. Chen, and S. Sun, “Sampling to achieve the goal: An age-aware remote Markov decision process,” in 2024 IEEE Information Theory Workshop (ITW). IEEE, 2024, pp. 121–126."
---

\[[arXiv](https://arxiv.org/abs/2405.02042)\]

<!-- ![](https://arxiv.org/html/2405.02042/x1.png) -->
