...
permalink: /publication/2025-04-01-rf-challenge
excerpt: 'Presents the Data-Driven RF Signal Separation Challenge as a benchmark for interference rejection, detailing the dataset, evaluation protocol, and baseline solutions to enable comparable, repeatable progress in learning-based RF separation research.'
date: 2025-04-01
venue: 'IEEE Open Journal of the Communications Society'
citation: "A. Lancho, A. Weiss, G. C. Lee, T. Jayashankar, B. G. Kurien, Y. Polyanskiy, and G. W. Wornell, “RF challenge: The data-driven radio frequency signal separation challenge,” IEEE Open Journal of the Communications Society, 2025."
---
